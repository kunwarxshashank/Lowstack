...
const columns = [
  ...
  return (
    <>
      <h1 className="text-base-800 text-lg font-medium">Users</h1>
      <Table data={UserDatas} columns={columns} isLoading={loading} />
      <h1 className="text-base-800 text-lg font-medium">Documents</h1>
      <Table data={postDatas} columns={postColumns} isLoading={PostLoading} />
      <h1 className="text-base-800 text-lg font-medium">Subject</h1>
      <Table
        data={subjectDatas}
