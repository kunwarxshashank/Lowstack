        ...
        <div className="bg-base-100/60 backdrop-blur-xl border border-base-content/5 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
          <div className="p-8">
            ...
            <button
              ...
              className="btn btn-outline w-full gap-3 hover:bg-base-content/5 border-base-content/10 hover:border-base-content/20 text-base-content transition-all duration-300 relative overflow-hidden group mb-8"
            >
              {isGoogleLoading ? (
            ...
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-base-100/50 backdrop-blur px-2 text-base-content/40">Or register with email</span>
              </div>
            </div>
