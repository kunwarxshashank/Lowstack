...
const FavouritesPage = () => {
    ...
    return (
        <div className="min-h-screen pb-8">
            ...
            <div className="relative mb-6 md:mb-8 overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-rose-500 via-pink-500 to-orange-400 p-4 md:p-6 lg:p-8 shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4">
                    <div className="p-2 md:p-2.5 lg:p-3 bg-white/20 backdrop-blur-sm rounded-xl md:rounded-2xl">
                        <BookmarkIcon className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-white" />
                    </div>
